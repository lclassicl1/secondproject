...
<form id="clubCreate" action="${path}/club/clubCre" method="post">
<table border="1" style="text-align:center;">
	...
	<tr>
		<th><input type="button" onclick="sample4_execDaumPostcode()" value="활동지역(동) "></th>
		<td><input type="hidden" id="sample4_roadAddress"/> <!-- 도로명주소 -->
			...
			<input type="text" id="sample4_extraAddress" required="required"/><!-- 동 주소 -->
		</td>
	</tr>
	<tr>
		<th>소개글</th>
